package com.yayass.training.adapter;
...
import com.yayass.training.activity.ui.training.DetailTrainingActivity;
import com.yayass.training.helper.Config;
import com.yayass.training.model.ResponseErrorModel;
import com.yayass.training.model.TrainingModel;
...
public class TrainingAdapter extends RecyclerView.Adapter<TrainingAdapter.TrainingViewHolder> {
    ...
    public TrainingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_training,
                parent, false);
